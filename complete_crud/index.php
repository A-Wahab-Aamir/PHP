...
<h5>By Abdul Wahab Amir</h5>
   ...
   <table align="right">
    <tr>
      <td><a href="deleteall.php" class="nav-link text-white bg-danger"  onclick="return del()">Delete All</a></td>
    </tr>
   </table>
</div>
...
<?php 
  ...
  echo "<table align='CENTER'><tr><td><h4 class='text-success fw-bold m-5 p-5'>NO RECORDS FOUND (<a href='add.php' class='text-success'>INSERT RECORD FIRST</a>)</h4></td></tr></table>";
}
